        ...
        <div className="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div className="col-lg-4">
                <Link to="/" className="text-decoration-none">
                    ...
                    <span className="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Cart</span>
                </Link>
            </div>
            ...
            <div className="col-lg-9">
                <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" className="text-decoration-none d-block d-lg-none">
                        ...
                        <span className="h1 text-uppercase text-light bg-primary px-2 ml-n1">CART</span>
                    </a>
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div className="navbar-nav mr-auto py-0">
                            ...
                            <Link to="/single-product-page" className="nav-item nav-link">Shop Detail</Link>
